...
const char *ssid = "U+NetF53F";
const char *password = "1000018563";

const int firstIndex = 0;
const int httpPort = 8080; //the port number for the http connection

String deviceNum = "a0000000";

const char* host = "ec2-52-79-220-144.ap-northeast-2.compute.amazonaws.com"; //the name of the host   i.e. ip address
String url = "/collect"; //the target URL    i.e. /update?api_key=UT2ARHHTXT1TNPKK
...
void sendData(String dataString) {
  ...
  String header = "GET " + String(url) + "?deviceNum=" + String(deviceNum) + "&" + String(dataString) + " HTTP/1.1";
